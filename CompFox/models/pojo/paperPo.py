...
class PaperPo(DefaultDbModel):
    ...
    试卷表实体类
    """
    table_alias: ClassVar[str] = 'compfox_papers'
    create_table_sql = f"""
        -- 合规试卷表
        CREATE TABLE IF NOT EXISTS `{table_alias}` (
            ...
            `subject` VARCHAR(50) COMMENT '合规领域',
            ...
            `pass_score` DECIMAL(5,2) COMMENT '合格线（金融合规场景必须）',
        ...
        ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='合规试卷表';
        """
    ...
    pass_score: Optional[float] = Field(None, description="合格线")
